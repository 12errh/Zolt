...
def test_discovers_app_subclass(tmp_path: pytest.TempDir) -> None:
...
def test_raises_if_no_app_subclass(tmp_path: pytest.TempDir) -> None:
...
def test_raises_if_module_has_syntax_error(tmp_path: pytest.TempDir) -> None:
...
def test_app_with_page_discovered(tmp_path: pytest.TempDir) -> None:
