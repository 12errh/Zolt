...
def _testimonial(quote: str, name: str, role: str, initials: str) -> Flex:
    card = Flex(direction="col", gap=4).className(
        "bg-white rounded-2xl p-6 border border-gray-100 shadow-[0_1px_3px_rgba(0,0,0,0.06)]"
    )
    with card:
        # Stars
        RawHTML(
    ...
    def compose(self) -> None:  # noqa: PLR0915
        with Flex(direction="col", gap=0).className("min-h-screen bg-white"):
            ...
            with Flex(align="center", justify="between").className(
                "sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 px-8 py-4"
            ):
                # Logo
                with Flex(align="center", gap=2):
                    ...
                    Text("PyUI").className("text-lg font-bold text-gray-950 tracking-tight")
                ...
                with Flex(align="center", justify="center", gap=6).className("mt-12 flex-wrap"):
                    for value, label in [
                        ...
                        with Flex(direction="col", align="center", gap=0):
                            Text(value).className("text-2xl font-bold text-gray-950 tracking-tight")
                        ...
                        with Flex(direction="col", gap=3):
                            for step, desc in [
                                ...
                                with Flex(align="center", gap=3):
                                    ...
                                    with Flex(direction="col", gap=0):
                                        Text(step).className("text-sm font-semibold text-white")
...
class App(App):
    home = HomePage()""")
            ...
            # ── Features ──────────────────────────────────────────────────────
            with Flex(direction="col", align="center").className("px-6 py-20").id("features"):
                pass
            ...
            with Flex(align="center", justify="center", gap=0).className(
                ...
                for i, (val, label) in enumerate(
                    ...
                    with Flex(direction="col", align="center", gap=1).className("px-10"):
                        Text(val).className("text-3xl font-bold text-white tracking-tight")
            ...
            with (
                ...
                with Flex(direction="col", align="center", gap=4).className("text-center mb-14"):
            ...
            with (
                ...
                with Flex(direction="col", align="center", gap=4).className("text-center mb-14"):
                    ...
                    Text("Every component you need to build a real product.").style(
                        "muted"
                    ).paragraph()
            ...
            with Flex(direction="col", align="center", justify="center").className(
                ...
                Text("Install PyUI, run the storybook, and ship your first UI today.").className(
                    "text-gray-400 text-lg mb-10 font-light"
                ).paragraph()
            ...
            with Flex(align="center", justify="between").className(
                ...
                Text("Built with pure Python. No HTML. No JavaScript.").className(
